...
package net.anirudh.as3syntaxhighlight
{
    ...
    public class CodePrettyPrint
    {
        ...
        public function prettyPrintAsync(sourceCodeHtml:String, opt_langExtension:String, completeFn:Function, intFn:Function, systemManagerIn:*, buildHTML:Boolean=false):void
        {
